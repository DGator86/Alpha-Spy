...
CURRENT_POLICY_VERSION = "alpha-v2-closed-loop-2026-09-02-r2"
...
POLICY_CONTRACT = {
    ...
    "option_surface": "full_universe_no_arbitrage_sanity_before_pq_enumeration",
    ...
    "governance": "current_policy_forward_actual_chain_independent_sessions_confidence_bounds",
}
